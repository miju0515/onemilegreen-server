...
import orgmeanapi.onemilegreen.Domain.GreenSeoul;
import orgmeanapi.onemilegreen.Domain.SeoulStatus;
import orgmeanapi.onemilegreen.Domain.UserStatus;
...
public class GSService {
    ...
    public UserStatus getUserData(int user_no){
        return jdbcTemplate.queryForObject("select User.user_mileage,User.user_effect,User.district from User where User.user_no=?", new RowMapper<UserStatus>() {
            @Override
